...
public class FingersPoseSO : ScriptableObject
{
    ...
    //        result.pose_data[i].secondPhalanxRotation = Quaternion.Slerp(a.pose_data[i].secondPhalanxRotation, b.pose_data[i].secondPhalanxRotation, t);
    //        result.pose_data[i].thirdPhalanxRotation = Quaternion.Slerp(a.pose_data[i].thirdPhalanxRotation, b.pose_data[i].thirdPhalanxRotation, t);
    //    }
    //}
    ...
    public void set_data(FingersPoseSO data)
    {
        ...
        Array.Copy(data.pose_data, 0, pose_data, 0, pose_data.Length);
    }
}